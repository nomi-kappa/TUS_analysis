...
model1 <- glmer(correct ~ OutValence + req_action + condition +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))); summary(model1)
...
model3 <- glmer(correct ~ OutValence * condition + req_action  + trial_number +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model3) 


#good
model3.b <- glmer(correct ~ OutValence * condition +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model3.b) 
#relatively good
model4 <- glmer(correct ~ OutValence * req_action * condition +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))) ;summary(model4) 

#relatively good
model4.b <- glmer(correct ~ OutValence * req_action * condition * trial_number +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))) ;summary(model4.b)

#failed to converge and not good
model4.c <- glmer(correct ~ condition * trial_number * OutValence +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model4.c) 
#not sure, but not bad
model5 <- glmer(correct ~condition*trial_number + req_action + condition*req_action + OutValence + condition*OutValence + req_action*OutValence +(1|ID) , data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model5)#ignore most probably
...
model6 <- glmer(correct ~ Cue + condition +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model6) 
...
model8 <- glmer(correct ~ Cue * condition + trial_number +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))) ;summary(model8) 


#failed to converge but gives info
model9 <- glmer(correct ~ Cue * condition * trial_number +(1|ID) , 
                 data  = tus_included_without_biggerthan20, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))); summary(model9)
...
model_rt1 <- lmer(log_RT ~ req_action*OutValence*condition +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE) ;summary (model_rt1) 
...
model_rt2 <- lmer(log_RT ~ OutValence*req_action*condition*trial_number +(1|ID), data  = tus_included, REML = FALSE) ;summary (model_rt2)
...
model_rt3 <- lmer(log_RT ~ OutValence*req_action*condition +trial_number +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE); summary (model_rt3) # good 

#better than 3
model_rt4 <- lmer(log_RT ~ req_action*OutValence*condition +  condition*trial_number +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE) ;summary (model_rt4) #good too

model_rt5 <- lmer(log_RT ~ Cue*condition + trial_number +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE) ; summary (model_rt5)#

#good
model_rt6 <- lmer(log_RT ~ Cue*condition  +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE) ; summary (model_rt6)#

#good all significant
model_rt7 <- lmer(log_RT ~ condition + OutValence  +trial_number +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE) ;summary (model_rt7)# main effects

model_rt8<- lmer(log_RT ~ Cue*condition* trial_number +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE) ; summary (model_rt8)#not much
