...
model29 <- glmer(correct ~ reward* condition*Cue  + (1|ID), 
...
#better than 3
model_rt4 <- lmer(log_RT ~ req_action*OutValence*condition +  condition*trial_number +(1|ID), data  = tus_filtered_, REML = FALSE) ;summary (model_rt4) #good too
