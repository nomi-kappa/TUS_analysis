...
model_rt6 <- lmer(RT ~ Cue*condition + trial_number +(1|ID), data  = tus, REML = FALSE) 
summary (model_rt6)#

model_rt7 <- lmer(RT ~ condition + OutValence + req_action +trial_number +(1|ID), data  = tus, REML = FALSE) 
