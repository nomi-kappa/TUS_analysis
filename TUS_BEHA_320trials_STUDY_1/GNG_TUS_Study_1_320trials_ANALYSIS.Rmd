...
tus_included_without_biggerthan20<- read_csv("tus_included_without_biggerthan20.csv")
...
model_rt7 <- lmer(log_RT ~ condition + OutValence + req_action +trial_number +(1|ID), data  = tus_included_without_biggerthan20, REML = FALSE) ;summary (model_rt7)# main effects
