...
tus_filtered<- read_csv ("GNG_tus_filtered_valid_S1.csv")
...
tus_excluded$req_action<-as.factor(tus_excluded$req_action)
tus_included_without_biggerthan20$ID<-as.factor(tus_included_without_biggerthan20$ID)
...
tus_filtered_ex$ID<-as.factor(tus_filtered_ex$ID)
...
tus_excluded <- within(tus_excluded, req_action <- relevel(req_action, ref = "noGo"))
tus_included_without_biggerthan20 <- within(tus_included_without_biggerthan20, req_action <- relevel(req_action, ref = "noGo"))

tus_filtered_ex <- within(tus_filtered_ex, req_action <- relevel(req_action, ref = "noGo"))
...
model3.b <- glmer(correct ~ OutValence * condition +(1|ID) , 
                 data  = tus_filtered_ex, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model3.b) 



#relatively good
model4 <- glmer(correct ~ OutValence * req_action * condition +(1|ID) , 
                 data  = tus_filtered_ex, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))) ;summary(model4) 
#relatively good
model4.b <- glmer(correct ~ OutValence * req_action * condition * trial_number +(1|ID) , 
                 data  = tus_filtered_ex, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))) ;summary(model4.b)

#failed to converge and not good
model4.c <- glmer(correct ~ condition * trial_number * OutValence +(1|ID) , 
                 data  = tus_filtered_ex, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model4.c) 
...
model6 <- glmer(correct ~ Cue + condition +(1|ID) , 
                 data  = tus_filtered_ex, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)));summary(model6) 
...
model8 <- glmer(correct ~ Cue * condition  +(1|ID) , #_trial_number
                 data  = tus_filtered_ex, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))) ;summary(model8) 


#failed to converge but gives info
model9 <- glmer(correct ~ Cue * condition * trial_number +(1|ID) , 
                 data  = tus_filtered_ex, family="binomial", glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))); summary(model9)
...
model_rt1 <- lmer(log_RT ~ req_action*OutValence*condition +(1|ID), data  = tus_filtered_ex, REML = FALSE) ;summary (model_rt1) 
...
model_rt2 <- lmer(log_RT ~ OutValence*req_action*condition*trial_number +(1|ID), data  = tus_filtered_ex, REML = FALSE) ;summary (model_rt2)
model_rt2.a <- lmer(log_RT ~ OutValence*condition*trial_number +(1|ID), data  = tus_filtered_ex, REML = FALSE) ;summary (model_rt2.a)
...
model_rt3 <- lmer(log_RT ~ OutValence*req_action*condition +trial_number +(1|ID), data  = tus_filtered_ex, REML = FALSE); summary (model_rt3) # good 

#better than 3
model_rt4 <- lmer(log_RT ~ req_action*OutValence*condition +  condition*trial_number +(1|ID), data  = tus_filtered_ex, REML = FALSE) ;summary (model_rt4) #good too
...
model_rt8<- lmer(log_RT ~ Cue*condition* trial_number +(1|ID), data  = tus_filtered_ex, REML = FALSE) ; summary (model_rt8)# good especially after jaka exclusion
