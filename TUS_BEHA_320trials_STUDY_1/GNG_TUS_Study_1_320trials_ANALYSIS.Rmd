...
model22.b<-glmer(followup_beha_binary ~ reward * condition   +(1|ID) ,
                 data  = tus_filtered, family="binomial",  glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5))); summary(model22.b)
```
...
skewness(tus_included$RT, na.rm = TRUE)
# Add a small constant to the data
small_constant <- 0.0001  # Adjust as needed
tus_included$RT <- tus_included$RT + small_constant
tus_included <- tus_included %>%
  mutate(log_RT = log10(RT))



skewness(tus_included_without_biggerthan20$RT, na.rm = TRUE)
# Add a small constant to the data
small_constant <- 0.0001  # Adjust as needed
tus_included_without_biggerthan20$RT <- tus_included_without_biggerthan20$RT + small_constant
tus_included_without_biggerthan20 <- tus_included %>%
  mutate(log_RT = log10(RT))

skewness(tus_clean_allexs$RT, na.rm = TRUE)
# Add a small constant to the data
small_constant <- 0.0001  # Adjust as needed
tus_clean_allexs$RT <- tus_clean_allexs$RT + small_constant
tus_clean_allexs <- tus_clean_allexs %>%
  mutate(log_RT = log10(RT))
...
# Add a small constant to the data
small_constant <- 0.0001  # Adjust as needed
tus_filtered$RT <- tus_filtered$RT + small_constant
tus_filtered <- tus_filtered %>%
  mutate(log_RT = log10(RT))

skewness(tus_filtered_ex$RT, na.rm = TRUE)
# Add a small constant to the data
small_constant <- 0.0001  # Adjust as needed
tus_filtered_ex$RT <- tus_filtered_ex$RT + small_constant
tus_filtered_ex <- tus_filtered_ex %>%
  mutate(log_RT = log10(RT))
```
...
tus_included$req_action <- as.factor(tus_included$req_action)
tus_included$req_action <- relevel(tus_included$req_action, ref = "noGo")


tus_included_without_biggerthan20$req_action <- as.factor(tus_included_without_biggerthan20$req_action)
tus_included_without_biggerthan20$req_action <- relevel(tus_included_without_biggerthan20$req_action, ref = "noGo")

tus_clean_allexs$req_action <- as.factor(tus_clean_allexs$req_action)
tus_clean_allexs$req_action <- relevel(tus_clean_allexs$req_action, ref = "noGo")

tus_filtered$req_action <- as.factor(tus_filtered$req_action)
tus_filtered$req_action <- relevel(tus_filtered$req_action, ref = "noGo")

tus_filtered_ex$req_action <- as.factor(tus_filtered_ex$req_action)
tus_filtered_ex$req_action <- relevel(tus_filtered_ex$req_action, ref = "noGo")
