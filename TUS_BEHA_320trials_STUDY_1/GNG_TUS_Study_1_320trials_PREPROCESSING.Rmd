...
```
      ...
      #plot of the above per Cue (IES_by_cond_cue)
```{r}
library(ggplot2)
...
2. "excluded" column to shor whether included or excluded
```{r}
...
write.csv(tus_filtered, "GNG_tus_filtered_S1.csv") # 4blocks with inconsistencies for some and any trials that cue is presented over 20 times per block (exclude also 3 conds eemr and sinb)
