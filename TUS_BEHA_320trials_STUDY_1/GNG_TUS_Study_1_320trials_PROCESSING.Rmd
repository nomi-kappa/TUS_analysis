...
```{r}
a<-ggplot(tus_filtered, aes(x = TrialCount, y = cumulative_reward_win, color = condition)) +
  geom_smooth(method = "loess", se = TRUE, size = 1.2, alpha = 0.2) +  # Smooth curve with standard error
  labs(
    x = "Trial Count",
    y = "Cumulative Reward",
...
b<-ggplot(tus_filtered, aes(x = TrialCount, y = cumulative_reward_avoid, color = condition)) +
  geom_smooth(method = "loess", se = TRUE, size = 1.2, alpha = 0.2) +  # Smooth curve with standard error
  labs(
    x = "Trial Count",
    y = "Cumulative Reward",
...
```{r}
c<-ggplot(tus_filtered, aes(x = trial_number, y = cumulative_reward_win, color = condition)) +
  geom_smooth(method = "loess", se = TRUE, size = 1.2, alpha = 0.2) +  # Smooth curve with standard error
  labs(
    x = "Trial Number",
    y = "Cumulative Reward",
...
d<-ggplot(tus_filtered, aes(x = trial_number, y = cumulative_reward_avoid, color = condition)) +
  geom_smooth(method = "loess", se = TRUE, size = 1.2, alpha = 0.2) +  # Smooth curve with standard error
  labs(
    x = "Trial Number",
    y = "Cumulative Reward",
