...
#plot
GW<-ggplot(MeanGoResp_gw) + 
  geom_smooth(aes(TrialCount, GoResponse, color="red" )) +
  scale_colour_brewer(palette = "Set1") +
...
#plot
GAL<-ggplot(MeanGoResp_gal) + 
  geom_smooth(aes(TrialCount, GoResponse)) +
  scale_colour_brewer(palette = "Set1") +
   facet_grid(~condition)+
   xlim(NA, 20)+
...
salient_df <-tus_salient %>% drop_na();  
